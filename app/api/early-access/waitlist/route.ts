...
export async function POST(req: NextRequest) {
  try {
    ...
    // â”€â”€ Step 1: send OTP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (action === 'send_otp') {
        ...
        html: `
          <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:520px;margin:0 auto;background:#09090b;color:#fafafa;border-radius:16px;overflow:hidden;">
            <div style="padding:32px 32px 0;">
              <div style="font-size:11px;letter-spacing:0.12em;color:#78716c;text-transform:uppercase;margin-bottom:6px;">docrud Â· Early Bird Access</div>
    ...
    // â”€â”€ Step 2: verify OTP and enroll â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        await sendTrackedMail({
          ...
          html: `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:520px;margin:0 auto;background:#09090b;color:#fafafa;border-radius:16px;overflow:hidden;">
              <div style="padding:32px 32px 0;">
                <div style="font-size:11px;letter-spacing:0.12em;color:#78716c;text-transform:uppercase;margin-bottom:6px;">docrud Â· Early Bird Access</div>
                <h2 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#fafafa;">You're on the list! ðŸŽ‰</h2>
              ...
              <div style="margin:0 32px 24px;background:linear-gradient(135deg,#1c1917,#0c0a09);border:1px solid #292524;border-radius:12px;padding:24px;">
                ...
                <div style="display:flex;flex-direction:column;gap:12px;">
                  <div style="font-size:14px;color:#d6d3d1;">âœ… &nbsp;You're verified and saved on the waitlist</div>
                  <div style="font-size:14px;color:#d6d3d1;">ðŸ“¬ &nbsp;We'll notify you first when this launches</div>
                  <div style="font-size:14px;color:#d6d3d1;">ðŸŽ &nbsp;Early birds get special launch pricing</div>
                </div>
              </div>
              <div style="padding:0 32px 32px;">
